---
name: "cb"
description: "Bundle multiple cxt[N].md files into a single archive file with numbering headers. Zero Distortion, Zero Omission deadly enforcement. Supports simple request format: 'Use Skill: cb X ~ Y'. (Alias for context-bundler)"
---

# Context Bundler (cb Alias)
...
4. ✅ Always: Recognize "Use Skill: cb X ~ Y"

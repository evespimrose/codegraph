...
3. **Generate File**: Create or update `docs/contextmd/cxt[N].md` with this exact structure:
   ...
   ...
   ```
   **⚠️ 1행: 제목, 2행: BLK 태그, 3행: CAVE-MAN-REMINDER — 이 순서 절대 변경 금지**
   **⚠️ CAVE-MAN-REMINDER (3행)는 Claude L5 외부 이전 결과 — 모든 cxt에 의무 포함**
4. **Format Content**:
...
4. ❌ **NEVER DO**: Save cxt file without CAVE-MAN-REMINDER on line 3
...
9. ✅ **ALWAYS DO**: Include CAVE-MAN-REMINDER on line 3 (L5 외부 이전 책임)

'use strict';
//
// Programmatic / embedded SDK entry for @evespimrose/codegraph (issue #354).
//
...
// API — `require("@evespimrose/codegraph")` returning the CodeGraph class et al.
//
// The compiled library + its production dependencies (web-tree-sitter,
// tree-sitter-wasms, …) ship INSIDE the per-platform bundle, at
//   @evespimrose/codegraph-<platform>-<arch>/lib/dist/index.js
...
var pkg = '@evespimrose/codegraph-' + target;
...
function resolveLibrary() {
  ...
  throw new Error(
    ...
    '      npm i @evespimrose/codegraph --registry=https://registry.npmjs.org\n' +
    '  - or run the CLI once (e.g. `npx @evespimrose/codegraph status`) to\n' +

...
/**
 * Append a `[X.Y.Z]: https://github.com/evespimrose/codegraph/releases/tag/vX.Y.Z`
...
function appendLinkRef(text, version) {
  const refLine = `[${version}]: https://github.com/evespimrose/codegraph/releases/tag/v${version}`;
